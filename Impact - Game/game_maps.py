...
# -----------------------------------------------------------------------------
"""
Maps and the system for the game. Very nice dict usage
"""
# -----------------------------------------------------------------------------
...
battle_1 = {"location_name": "Battle 1!",
            ...
            "actual_tutorial": "The spider robot is ahead of you! Move the player "
            "with WASD to the spider bot, and press Q to start the battle!",
...
tutorial_spawn = {
    ...
    "tutorial": "Move around with W, A, S, D, and use F, and E to go to other "
    "areas. If you need help, type ?",
    ...
    "teleport":
        {
            "tutorial_spawn to tutorial_level_1": {"start_coord": (7, 2), 
                                                   "target_map": 
                                                   lambda: tutorial_level, 
                                                   "end_coord": (0, 0)},
            "tutorial_spawn to tutorial_level_2": {"start_coord": (7, 3), 
                                                   "target_map": 
                                                   lambda: tutorial_level, 
                                                   "end_coord": (0, 1)},
            "tutorial_spawn to tutorial_level_3": {"start_coord": (7, 4), 
                                                   "target_map": 
                                                   lambda: tutorial_level, 
                                                   "end_coord": (0, 2)},
    },
...
tutorial_level = {
    ...
    "teleport":
        {
            "tutorial_level to tutorial_spawn_1": {"start_coord": (-1, 0), 
                                                   "target_map": 
                                                   lambda: tutorial_spawn, 
                                                   "end_coord": (6, 2)},
            "tutorial_level to tutorial_spawn_2": {"start_coord": (-1, 1), 
                                                   "target_map": 
                                                   lambda: tutorial_spawn, 
                                                   "end_coord": (6, 3)},
            "tutorial_level to tutorial_spawn_3": {"start_coord": (-1, 2), 
                                                   "target_map": 
                                                   lambda: tutorial_spawn, 
                                                   "end_coord": (6, 4)},
    },
